    ...
    <div className="space-y-4">
      ...
      <table className="min-w-full divide-y divide-gray-200 text-sm">
        <thead className="bg-gray-50">
          <tr><th className="px-6 py-5 text-left font-bold text-gray-400 uppercase tracking-widest text-[9px]">Page URL</th><th className="px-6 py-5 text-center font-bold text-gray-400 uppercase tracking-widest text-[9px]">Citability</th><th className="px-6 py-5 text-center font-bold text-gray-400 uppercase tracking-widest text-[9px]">Issues Found</th></tr>
        </thead>
        <tbody className="divide-y divide-gray-100">
          {data.pages.map(p => (
            <tr key={p.url} onClick={() => onPageClick(p.url)} className="hover:bg-green-50/30 cursor-pointer transition-colors group">
              ...
              <td className="px-6 py-4 text-center"><CitabilityBadge grade={p.citability_grade} /></td>
