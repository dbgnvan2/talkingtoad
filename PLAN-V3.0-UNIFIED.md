...
| **M3** | Google-validated GEO **audit** extensions | ✅ **Done (2026-05-31, orche)** | M3.1 `SCHEMA_VISIBLE_MISMATCH` `345c935` · M3.2 `AI_CONTENT_NOT_IN_TEXT` `96a2a24` · M3.3 `AI_PREVIEW_SUPPRESSED`/`AI_PREVIEW_BLOCKED_AT_BOT` `3d0f119` · M3.4 `AI_NO_VISUAL_COMPANION` `e631756` · M3.5 `AI_MAIN_CONTENT_LOW_RATIO` `e2b53a0` · M3.6 scoring-scope fix `6b3f1c0`. All reviewed; full suite 1559 passed, 0 fail. |
